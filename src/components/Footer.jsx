...
const tweetList = [
  {
    ...
    desc: (
      <p>
        Walas jibah <a href="#">@ShopCart Greetings! #HTML_Template</a> Grab
  ...
  },
  {
    ...
    desc: (
      <p>
        Danah jibah <a href="#">@ShopCart Hey! #HTML_Template</a> Grab your
        ...
        <div className="container">
          <div className="section-wrapper">
            <p>
              ...
              <a href="http://kakwiri.vercel.app/" target="_blank">
                Vincent Mureti
              </a>{" "}
            </p>
